# Generated by Powerlevel10k configuration wizard on 2025-09-24 at 17:07 UTC.
...
# 12h time, round separators, round heads, flat tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    screen_session          # GNU Screen session name
  ...
  # Display the GNU Screen session name if running inside screen.
  function prompt_screen_session() {
    [[ -n $STY ]] || return
    p10k segment -f 3 -i '󰍹' -t "${STY##*.}"
  }
